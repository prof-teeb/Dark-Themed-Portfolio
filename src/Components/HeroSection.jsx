...
import appMockup from '../../public/mockup.png'; 

const HeroSection = () => {
  return (
    <section
      className="min-h-screen flex items-center justify-center px-6 py-32  bg-top bg-no-repeat text-white"
      style={{ backgroundImage: "url('/mockup.png')"}}
    ...
    >
      ...
      <div className="container mx-auto text-center">
        ...
        >
          ...
          >
            <span className="text-white">Muhammmad</span>
          ...
          >
            I craft immersive web experiences with code, motion, and meaning. Clean, elegant, and modern – every pixel with a purpose.
          </motion.p>
